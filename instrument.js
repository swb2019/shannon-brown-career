...
export function createInstrument(canvas, onFailure) {
  ...
  for(let i=0;i<3;i++){
    ...
    const outline=new THREE.LineSegments(new THREE.EdgesGeometry(frameGeometry,28),new THREE.LineBasicMaterial({color:i===1?0xb9c5b4:0x597066,transparent:true,opacity:.65}));group.add(outline);
